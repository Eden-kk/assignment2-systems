...
from cs336_systems.implementations.ddp_overlap_bucketed_parameters import (
...
from cs336_systems.implementations.sharded_optimizer import get_sharded_optimizer as _get_sharded_optimizer
...
def ddp_individual_parameters_on_after_backward(ddp_model: torch.nn.Module, optimizer: torch.optim.Optimizer):
    ...
    """
    _ddp_individual_parameters_on_after_backward(ddp_model, optimizer)
